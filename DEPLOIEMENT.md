...
Le schéma des 22 tables se crée **tout seul au premier démarrage**. Si
...
Il doit afficher `49/49 vérifications réussies`.
...
Elle doit afficher `98/98 tests réussis` dans les deux cas.
