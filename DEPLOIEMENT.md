...
Le schéma des 23 tables se crée **tout seul au premier démarrage**. Si
...
Il doit afficher `79/79 vérifications réussies`.
...
Elle doit afficher `311/311 tests réussis` dans les deux cas.
