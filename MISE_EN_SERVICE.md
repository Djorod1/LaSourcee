...
```bash
cd backend
python tests_integration.py       # doit afficher 98/98 tests réussis
```
...
- [ ] `python tests_integration.py` affiche 98/98
- [ ] `python tests_deploiement.py` affiche 49/49 (déploiement serverless)
