...
```bash
cd backend
python tests_integration.py       # doit afficher 425/425 tests réussis
```
...
- [ ] `python tests_integration.py` affiche 425/425
- [ ] `python tests_deploiement.py` affiche 85/85 (déploiement serverless)
